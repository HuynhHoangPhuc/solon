...
2. If no logo provided: generate with `sl:ai-multimodal` skill
3. Screenshot wireframes with browser DevTools → save to `./docs/wireframes/`
...
Activate **sl:plan** skill: `/sl:plan --fast <requirements>`
