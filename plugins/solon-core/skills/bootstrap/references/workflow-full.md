...
4. If no logo provided: generate with `sl:ai-multimodal` skill
5. Screenshot wireframes with browser DevTools → save to `./docs/wireframes/`
...
Activate **sl:ship** skill: `/sl:ship <plan-path>` (interactive mode — review gates at each step)
