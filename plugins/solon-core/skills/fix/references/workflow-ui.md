...
1. Design database (ALWAYS FIRST)
2. Design principles
...
Analyze screenshots/videos with `sl:ai-multimodal` skill.
...
Screenshot + `sl:ai-multimodal` analysis.
...
Use browser DevTools or relevant debugging tools.
...
## Tips
- Use `sl:ai-multimodal` for generating visual assets
