...
Activate `sl:debug` skill. Launch 2-3 `Explore` subagents in parallel:
```
...
Implement per plan. Use `sl:problem-solving`, `sl:sequential-thinking`.
...
|------|------------------|
| 1 | `sl:debug`, parallel `Explore` subagents for investigation |
| 2 | `researcher` (runs parallel with step 1) |
| 3 | `sl:brainstorm` |
| 4 | `planner` |
| 5 | `sl:problem-solving`, `sl:sequential-thinking`, parallel `Bash` |
| 6 | `tester` |
| 7 | `code-reviewer` |
| 8 | `project-manager`, `docs-manager`, `Bash` |

**Rules:** Don't skip steps. Validate before proceeding. One phase at a time.
**Frontend:** Use `chrome` or any relevant skills/tools to verify.
**Visual Assets:** Use `sl:ai-multimodal` for visual assets generation, analysis and verification.
