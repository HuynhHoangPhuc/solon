...
def find_api_key() -> Optional[str]:
    ...
    5. <plugin-dir>/skills/ai-multimodal/.env (skill-specific)
    6. <plugin-dir>/skills/.env (shared skills)
...
def batch_process(
    ...
    if not api_key:
        ...
        print("4. Create .env: cd <solon-skills-plugin>/skills/ai-multimodal && cp .env.example .env")
