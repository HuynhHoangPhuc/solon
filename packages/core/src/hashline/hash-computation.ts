...
async function getHasher(): Promise<{ h32: (str: string, seed?: number) => number }> {
 ...
 */
export async function computeLineHash(lineNumber: number, content: string): Promise<string> {
