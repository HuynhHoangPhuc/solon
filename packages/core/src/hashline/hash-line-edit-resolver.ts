...
const RANGE_PATTERN = /([0-9]+#[ZPMQVRWSNKTXJBYH]{2})\.\.\.([0-9]+#[ZPMQVRWSNKTXJBYH]{2})/g;
 ...
 */
export async function resolveHashlineEdit(oldString: string, filePath: string): Promise<string> {
