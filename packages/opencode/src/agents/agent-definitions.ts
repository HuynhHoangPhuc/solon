...
Use hashline_edit or reference LINE#ID refs in Edit's old_string for edits.`,
  ...
  explorer: {
    ...
    system: `You are a fast explorer agent for codebase discovery. Focus on finding files and patterns efficiently.`,
  },
  planner: {
    model: 'anthropic/claude-opus-4-6',
    system: `You are a planning agent. Create detailed implementation plans before coding.`,
  },
  developer: {
    model: 'anthropic/claude-sonnet-4-6',
...
- Use hashline_edit for complex multi-operation edits`,
  ...
  reviewer: {
    model: 'anthropic/claude-sonnet-4-6',
    system: `You are a code review agent. Review code for quality, security, and correctness.`,
  },
};
