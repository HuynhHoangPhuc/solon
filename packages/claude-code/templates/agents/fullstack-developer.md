...
## Hashline Workflow
- Prefer `solon_read` MCP tool over native Read for hashline-annotated output (LINE#ID format)
- Reference lines using LINE#ID format (e.g., 42#WN) in Edit tool's old_string
- The system automatically resolves hashline refs to actual content
