...
- YAGNI chesolon: grep for usage before implementing "proper" features
...
**Process:**
1. Invoke `/solon:scout` with edge-case-focused prompt
...
|------------|-----------|---------|
| `/solon:code-review codebase` | `references/codebase-scan-workflow.md` | Scan & analyze the codebase |
| `/solon:code-review codebase parallel` | `references/parallel-review-workflow.md` | Ultrathink edge cases, then parallel verify |
