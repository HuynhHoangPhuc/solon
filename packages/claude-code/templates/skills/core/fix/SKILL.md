...
**Always activate:** `solon:debug` (all workflows)
**Conditional:** `solon:problem-solving`, `solon:sequential-thinking`, `solon:brainstorm`, `solon:context-engineering`
...
- `references/workflow-quick.md` - Quisolon: debug → fix → review
