...
Activate `solon:debug` skill. Launch 2-3 `Explore` subagents in parallel:
```
...
Activate `solon:brainstorm` skill.
...
Implement per plan. Use `solon:context-engineering`, `solon:sequential-thinking`, `solon:problem-solving`.
...
|------|------------------|
| 1 | `solon:debug`, parallel `Explore` subagents for investigation |
| 2 | `researcher` (runs parallel with step 1) |
| 3 | `solon:brainstorm` |
| 4 | `planner` |
| 5 | `solon:problem-solving`, `solon:sequential-thinking`, `solon:context-engineering`, parallel `Bash` |
| 6 | `tester` |
| 7 | `code-reviewer` |
| 8 | `project-manager`, `docs-manager`, `Bash` |

**Rules:** Don't skip steps. Validate before proceeding. One phase at a time.
**Frontend:** Use `chrome`, `solon:chrome-devtools` or any relevant skills/tools to verify.
**Visual Assets:** Use `solon:ai-multimodal` for visual assets generation, analysis and verification.
