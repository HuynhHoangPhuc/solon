...
Activate the solon:chrome-devtools skill.
...
## Workflow
- Use `solon:plan` skill to organize the test plan & report
...
- Use `solon:ai-multimodal` to analyze all screenshots
- Generate comprehensive Markdown report
- Ask user if they want to preview with `/solon:preview`
