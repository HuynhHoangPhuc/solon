...
Browser-based visual testing via `solon:chrome-devtools` skill. Screenshots, responsive checks, accessibility audits, form automation, console error collection. Includes auth injection for protected routes.
...
6. For frontend: run UI tests via `solon:chrome-devtools` skill
...
- **Browser**: `solon:chrome-devtools` skill for UI testing (screenshots, ARIA, console, network)
- **Analysis**: `solon:ai-multimodal` skill for screenshot analysis
- **Debugging**: `solon:debug` skill when tests reveal bugs requiring investigation
- **Thinking**: `solon:sequential-thinking` skill for complex test failure analysis
