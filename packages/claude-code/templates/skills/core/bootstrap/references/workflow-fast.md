...
2. If no logo provided: generate with `solon:ai-multimodal` skill
3. Screenshot wireframes with `solon:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **solon:plan** skill: `/solon:plan --fast <requirements>`
