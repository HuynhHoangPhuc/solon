...
3. If no logo provided: generate with `solon:ai-multimodal` skill
4. Screenshot wireframes with `solon:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **solon:plan** skill: `/solon:plan --auto <requirements>`
...
Activate **solon:cook** skill: `/solon:cook --auto <plan-path>`
