...
Handled by **solon:cook** skill. Bootstrap-specific notes:
...
- Asset pipeline: `solon:ai-multimodal` (generate/analyze) → `imagemagick` (crop/resize) → background removal if needed
