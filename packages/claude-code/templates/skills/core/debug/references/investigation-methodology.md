...
- Otherwise use `solon:repomix` to generate fresh codebase summary
- Use `/solon:scout` or `/solon:scout ext` to find relevant files
- Use `solon:docs-seeker` skill for package/plugin documentation
