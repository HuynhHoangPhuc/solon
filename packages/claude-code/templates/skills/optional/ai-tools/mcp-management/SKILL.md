...
**Fallbasolon: mcp-manager Subagent**
...
- Config loading from `$HOME/.claude/.mcp.json`
...
**Method 2: Scripts**
```bash
cd $HOME/.claude/skills/mcp-management/scripts && npm install
