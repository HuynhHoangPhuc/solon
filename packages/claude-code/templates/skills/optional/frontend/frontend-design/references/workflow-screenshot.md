...
## Prerequisites
- Activate `solon:ui-ux-pro-max` skill first for design intelligence
- Have `solon:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `solon:ai-multimodal` skill to extract:
...
### 4. Generate Assets
Use `solon:ai-multimodal` skill:
- Generate images, icons, backgrounds
- Verify generated assets match design
- Remove backgrounds if needed with `solon:media-processing`
